...
const PLANS_SEED = [
  {
    ...
    priceMonthlySar: 0,
    priceYearlySar: 0,
    // Sprint 16R — per-user pricing. Free hard cap 2 users (was 3).
    maxUsers: 2,
    maxCustomers: 100,
    maxDeals: 100,
    maxStorageGb: 1,
  ...
  },
  {
    ...
    // Sprint 16R — PER-USER pricing (₺ authoritative; USD/SAR are display
    // approximations for the internal admin MRR dashboard only). Monthly =
    // monthly-billed per-user rate; Yearly = annual-billed per-user rate × 12.
    priceMonthlyUsd: 13,
    priceYearlyUsd: 125,
    priceMonthlyTry: 499,
    priceYearlyTry: 4788,
  ...
  },
  {
    ...
    // Sprint 16R — PER-USER pricing (₺ authoritative; USD/SAR are display
    // approximations for the internal admin MRR dashboard only).
    priceMonthlyUsd: 29,
    priceYearlyUsd: 280,
    priceMonthlyTry: 1099,
    priceYearlyTry: 10788,
    priceMonthlySar: 107,
    priceYearlySar: 1051,
    maxUsers: 100,
    maxCustomers: 10000,
