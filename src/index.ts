...
import landingPublicRoutes from "./routes/landing-public.routes";
import adCampaignRoutes from "./routes/ad-campaign.routes";
...
import actionRecipesRoutes from "./routes/action-recipes.routes";
import aiStudioRoutes from "./routes/ai-studio.routes";
import dataToolsRoutes from "./routes/data-tools.routes";
...
import revenueBrainRoutes from "./routes/revenue-brain.routes";
...
import aiMessagingRoutes from "./routes/ai-messaging.routes";
...
app.use("/api/form-flows", formFlowsRoutes);
app.use("/api/action-recipes", actionRecipesRoutes);
...
app.use("/api/revenue-brain", revenueBrainRoutes);
...
app.use("/api/p", landingPublicRoutes);
...
app.use("/api/ai/messages", aiMessagingRoutes);
